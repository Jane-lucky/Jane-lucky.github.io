// Editor server accessible from public IP
// Change port from 3456 to 3458
process.env.EDITOR_PORT = 3458;
...
const PORT = process.env.EDITOR_PORT || 3458;
...
function handleRequest(req, res) {
  ...
  const getMatch = url.pathname.match(/^\/api\/posts\/(.+)$/);
...
server.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`🌐 Public: http://123.60.18.97:${PORT}`);
